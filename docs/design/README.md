...
**Event log:** durable semantic history + one UI reduce path; not a product “replay mode.” Contract: [vision](./01-vision.md) (event log table) · [wiring](./03-wiring.md) · [gui](./05-gui-rendering.md).
